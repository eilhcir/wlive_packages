...
class FlutterForbidshot {
  static const MethodChannel _methodChannel = const MethodChannel('flutter_forbidshot');
  static const EventChannel _eventChannel = const EventChannel('flutter_forbidshot_change');
